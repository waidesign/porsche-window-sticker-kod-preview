...
export default function InformationSection({ onSelectVin }: InformationSectionProps) {
  ...
  const annotations = [
    {
      ...
      coord: "top-[6%] left-[24%]",
      icon: <Layers className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 6,
      ...
      coord: "top-[5%] left-[54%]",
      icon: <PenTool className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 10,
      ...
      icon: <Activity className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 1,
      ...
      icon: <Sparkles className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 2,
      ...
      icon: <Info className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 3,
      ...
      icon: <Cpu className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 4,
      ...
      icon: <Shield className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 5,
      ...
      icon: <Award className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 7,
      ...
      icon: <DollarSign className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 8,
      ...
      icon: <HelpCircle className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 9,
      ...
      icon: <Truck className="w-4 h-4 text-[#A1FF2C]" />,
    },
    {
      id: 11,
    ...
    },
    {
      ...
      icon: <Star className="w-4 h-4 text-[#A1FF2C]" />,
    },
  ];
  ...
  return (
    <section id="info" className="py-24 bg-[#09090B] border-b border-zinc-900 no-print">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* What is a Porsche Window Sticker? */}
        <div className="mb-16 border-b border-zinc-800/60 pb-16">
          <div className="w-full">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight text-white leading-tight mb-6">
              What is a Porsche Window Sticker?
            </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center space-x-2 bg-zinc-900 border border-zinc-800 px-3 py-1.5 mb-2">
              <span className="w-1.5 h-1.5 bg-[#A1FF2C]"></span>
              <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-400 font-bold">
            ...
            <div className="mt-8 space-y-2.5 max-h-[580px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-zinc-800">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3.5 transition-all duration-300 border rounded-none ${
                      isActive
                        ? "border-[#A1FF2C] bg-zinc-950 shadow-[0_4px_20px_rgba(161,255,44,0.1)]"
                  ...
                  >
                      ...
                      <div className="flex items-center space-x-3">
                        <span
                          className={`flex items-center justify-center w-6 h-6 font-mono text-[10px] font-bold rounded-none border ${
                            isActive
                              ? "bg-[#A1FF2C] text-black border-[#A1FF2C]"
                    ...
                    {isActive && (
                      <p className="text-xs text-zinc-400 mt-2.5 pl-9 leading-relaxed font-light border-l border-[#A1FF2C]/30">
                        {ann.desc}
                      </p>
                    )}
                  </button>
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:sticky lg:top-28">
            <div className="w-full text-center mb-4 lg:hidden">
              <span className="text-[11px] font-mono text-[#A1FF2C] uppercase tracking-widest flex items-center justify-center gap-1.5">
                <Eye className="w-3.5 h-3.5" /> Tap the sticker hotspots to explore
              </span>
            </div>

            <div className="relative w-full max-w-[640px] aspect-[4/3] bg-zinc-950 border border-zinc-800 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] overflow-hidden rounded-none select-none">
                ...
                return (
                  <button
                    ...
                    className={`absolute ${ann.coord} flex items-center justify-center w-8 h-8 font-mono text-[11px] font-black rounded-full transition-all duration-300 z-20 -translate-x-1/2 -translate-y-1/2 cursor-pointer shadow-lg ${
                      isActive
                        ? "bg-[#A1FF2C] text-black scale-125 ring-4 ring-[#A1FF2C]/30 border-2 border-black"
                        : "bg-black/90 text-[#A1FF2C] border border-[#A1FF2C]/40 hover:bg-[#A1FF2C] hover:text-black hover:scale-110 hover:border-black"
                    }`}
                    title={ann.title}
                  >
        ...
        <div className="mt-24 pt-16 border-t border-zinc-900">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            ...
            <div>
              <span className="inline-flex items-center px-4 py-1.5 text-xs font-semibold font-mono text-[#A1FF2C] border border-[#A1FF2C]/20 bg-[#A1FF2C]/5 rounded-none">
                Refreshes daily
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <button
                ...
                className="text-center bg-zinc-950/40 p-5 border border-zinc-800/80 hover:border-[#A1FF2C] hover:bg-zinc-950 transition-all duration-300 group rounded-none focus:outline-none flex justify-center items-center shadow-sm"
              >
                <span className="font-mono text-xs sm:text-sm font-bold text-zinc-300 group-hover:text-[#A1FF2C] tracking-wider transition-colors">
                  {vin}
                </span>
              </button>
            ))}
